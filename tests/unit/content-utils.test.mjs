...
test('media extension mapping supports publishing inputs',()=>{assert.deepEqual(mediaMimeFromExtension('.MP4'),['video','video/mp4']);assert.deepEqual(mediaMimeFromExtension('.docx'),['docx','application/vnd.openxmlformats-officedocument.wordprocessingml.document']);assert.deepEqual(mediaMimeFromExtension('.TXT'),['text','text/plain']);});
