...
const problems=[];if(!html.includes('v0.5.0'))problems.push('src/index.html missing v0.5.0');const start=await fs.readFile(path.join(root,'start-server.bat'),'utf8');if(!start.includes('v0.5.0'))problems.push('start-server.bat missing v0.5.0');
...
console.log('UI static integrity: PASS — '+ids.length+' unique IDs; all querySelector ID targets exist; version markers match v0.5.0.');
