...
if not exist "dist\index.html" (
  ...
  echo This ZIP should contain a prebuilt runnable Visular AI Terms / Concepts v0.6.2 application.
  pause
  exit /b 1
)
echo Starting Visular AI Terms / Concepts v0.6.2 at http://localhost:%PORT%/
